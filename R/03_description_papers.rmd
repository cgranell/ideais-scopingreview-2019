...
The following cloud and table are based on word stems extracted with a stemming algorithm from package [`quanteda`](https://cran.r-project.org/package=quanteda).
...
# for (the_year in c(2010, 2011, 2012, 2013, 2015, 2016, 2017, 2018, 2019)) {
...
# }
  ...
  barplot(cloud_wordstems[1:15,]$n, las = 2, names.arg = cloud_wordstems[1:15,]$wordstem,
        ylim=range(pretty(c(0, cloud_wordstems[1:15,]$n))),
        col = c("#666666", "#666666", "#666666", 
                "#66A61E", "#66A61E", "#66A61E",
                "#E7298A", "#E7298A", "#E7298A", "#E7298A", "#E7298A", "#E7298A",
                "#7570B3", "#7570B3", "#7570B3"),
        main ="Top 15 most frequent wordstems",
        ylab = "Wordstem frequencies")
...
```{r cloud_wordstems_table, echo=FALSE}
