...
library(ggforce) # for sankey diagram
...
sankey %>%
  rename(`Application domain` = domain,
...
ggsave(here("figs", "fig04_parallelset.png"))

```

### Useful information/stats 

Tables below show the numbers and percentages used in Section 3 of the document. They are not shown as tables per se but as pieces of information intertwined in the narrative 
...
### Figure 5. Temporal distribution of virtual assistants considering _av_arch_ vs _av_status_
