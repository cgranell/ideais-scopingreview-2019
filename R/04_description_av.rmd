...
```{r fig5_old, fig.height=6, fig.width=10}
papers %>%
...
# Ordering data by place in decreasign order, to keep "Others" as the last colum
...
```{r research_areas_plot, fig.height=14, fig.width=12}
...
#TODO: POner table en dos columnas. Ajustar formato. Src: https://cran.r-project.org/web/packages/gridExtra/vignettes/tableGrob.html
tbl <- 
    tableGrob(
      ra_equal_one %>% 
        select(av_areas) %>%
...
png(filename = here::here("figs", "fig06.png"), 
    width=1280,
    height=800)
